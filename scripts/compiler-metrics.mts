...
const fileBudgets = {
  ...
  "native/zero-c/src/checker.c": { maxLines: 9805, maxStrcmpCalls: 279 },
  "native/zero-c/src/main.c": { maxLines: 9980, maxStrcmpCalls: 442 },
...
const knownLargeFunctionLimits = new Map([
  ...
  ["native/zero-c/src/main.c|static void append_graph_json(ZBuf *buf, SourceInput *input, Program *program, const ZTargetInfo *target, const Command *command) {", 376],
