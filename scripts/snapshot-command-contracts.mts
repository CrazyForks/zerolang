...
assert.equal(repoGraphSyncFromSource.body.repositoryGraph.syncState, "store-valid");
...
assert.equal(standaloneRepoGraphStatusWithStore.repositoryGraph.syncState, "store-valid");
...
writeFileSync(join(copiedRepoGraphRootA, "hello.0"), readFileSync("examples/hello.0", "utf8"));
writeFileSync(join(copiedRepoGraphRootB, "hello.0"), readFileSync("examples/hello.0", "utf8"));
const copiedRepoGraphSourceA = join(copiedRepoGraphRootA, "hello.0");
const copiedRepoGraphSourceB = join(copiedRepoGraphRootB, "hello.0");
...
const copiedRepoGraphVerify = json(["graph", "verify-sync", "--json", copiedRepoGraphSourceB], { allowFailure: true });
assert.notEqual(copiedRepoGraphVerify.code, 0);
assert.equal(copiedRepoGraphVerify.body.diagnostics[0].code, "RGP005");
...
assert.equal(repoGraphSyncFromGraph.body.diagnostics[0].code, "RGP004");
