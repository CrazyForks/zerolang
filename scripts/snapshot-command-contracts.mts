...
assert.match(graphHelp, /zero graph \[dump\|import\|validate\|roundtrip\] \[--json\] --out <program-graph> <input>/);
...
assert.match(rootHelp, /zero graph \[dump\|import\|validate\|roundtrip\] \[--json\] --out <program-graph> <file\.0\|file\.row\|project\|zero\.json\|graph-artifact>/);
