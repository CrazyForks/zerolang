...
const ZStdHelperInfo z_std_helpers[] = {
  ...
  {"std.collections.append", "usize", 3, {NULL}, {NULL}, "memory", "target-neutral", "writes caller storage; returns unchanged length on overflow", true, Z_STD_HELPER_KIND_COLLECTIONS_APPEND},
  ...
  {"std.collections.moveToFront", "usize", 3, {NULL}, {NULL}, "memory", "target-neutral", "writes caller storage; returns unchanged length for invalid index", true, Z_STD_HELPER_KIND_COLLECTIONS_LEN_INDEX},
  ...
  {"std.collections.removeSwap", "usize", 3, {NULL}, {NULL}, "memory", "target-neutral", "writes caller storage; returns unchanged length for invalid index", true, Z_STD_HELPER_KIND_COLLECTIONS_LEN_INDEX},
